...
- `src/test/java/com/example/utils/SmartFinderReporter.java`: encapsula el registro en logs y en el reporte Serenity, adjuntando capturas al encontrar el elemento.
